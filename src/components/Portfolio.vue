  ...
  export default {
    ...
    setup() {
      ...
      const portfolioItems = ref([
        { title: 'Creative Juice', description: '🥤 Creative Juice is an online platform that connects creative people and allows them to exchange knowledge and ideas online or face-to-face over coffee. Made with Vite + Vue 3 + Supabase + Bootstrap 5 + GSAP.', image: '../src/assets/images/portfolio-1.jpg', width: 600, height: 600 },
